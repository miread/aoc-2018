...
This is a game of taking turns arranging marbles in a circle, according to very
particular rules. The marbles are numbered starting with 0 and increasing by 1
...
Then, each player takes a turn placing the lowest-numbered remaining marble into
...
```
You must find the winning score in this lengthy game:  **"458 players; last
marble is worth 72019 points"**

# --- Part Two ---

What would the new winning score be if the number of the last marble were 100
times larger?
