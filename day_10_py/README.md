...
Your input is a list of coordinates, all given from your perspective; given
enough time, those positions and velocities will move the points into a cohesive
message!
...
Exactly how many seconds does it take for that message to appear?
